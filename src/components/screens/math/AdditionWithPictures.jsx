    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-3xl font-bold text-pink-600">Addition Adventure</h1>
        </div>
        {/* Reward Collection */}
        <Button
          variant="contained"
      ...
      {showIntro ? (
        ...
        <>
          <div className="text-center mb-4">
            <h2 className="text-2xl text-blue-500 font-bold">Level {currentLevel}</h2>
          </div>
          ...
          <div className="bg-blue-100 p-6 rounded-lg mb-4 shadow-md">
                ...
                <div className="text-center">
                  <DragDropContext onDragEnd={handleDragEnd}>
                    ...
                    <Droppable droppableId="basket">
                      {(provided) => (
                        <div
                          className="bg-yellow-200 p-4 rounded-lg flex flex-wrap justify-center items-center min-h-[100px] mt-6"
                          ref={provided.innerRef}
                          {...provided.droppableProps}
                        >
                          {basketItems.map((item, index) => (
                            <span key={index} className="text-6xl m-1">
                              {item}
                            </span>
                          ))}
                          {provided.placeholder}
                  ...
                  <p className="text-center text-lg mt-2">Your Basket</p>
                </div>
              </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md text-center">
                  ...
                  <div className="flex justify-center mt-2">
                    {[...Array(currentAddition.left + currentAddition.right)].map((_, i) => (
                      <span key={i} className="text-6xl m-1">
                        {currentAddition.picture}
                      </span>
                    ))}
                  </div>
        ...
        <div className="flex flex-col items-center justify-center h-64 text-gray-800">
          ...
          <h2 className="text-4xl font-bold text-green-600 mb-2">You Did It!</h2>
